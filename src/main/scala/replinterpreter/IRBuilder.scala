...
object IRBuilder {
  ...
  def trivialJSCtor: Trees.JSConstructorDef = {
    Trees.JSConstructorDef(JSCtorFlags, Nil, None,
        Trees.JSConstructorBody(Nil, JSSuperConstructorCall(Nil), Undefined() :: Nil))(
        EOH, None)
  }
